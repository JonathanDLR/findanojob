 ...
 */
final class Version20181025082308 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, nbre_stagiaire INT NOT NULL, descriptif LONGTEXT NOT NULL, INDEX IDX_AF86866FA4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stagiaire (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nom VARCHAR(40) NOT NULL, prenom VARCHAR(40) NOT NULL, adresse VARCHAR(100) NOT NULL, ville VARCHAR(60) NOT NULL, departement VARCHAR(60) NOT NULL, region VARCHAR(60) NOT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, age INT DEFAULT NULL, sexe VARCHAR(6) DEFAULT NULL, presentation LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_4F62F731A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
